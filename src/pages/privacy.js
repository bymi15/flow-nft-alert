export default function Privacy() {
  return (
    <>
      <div className="mt-5 p-5 break-words text-white">
        <div>
          <strong>
            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">February 23, 2023</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span>
            <span style={{ fontSize: 15 }}>
              ...
              <span data-custom-class="body_text">
                ...
                <bdt className="statement-end-if-in-editor" />) your information when you use our
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="https://flow-nft-alert.vercel.app"
                      target="_blank"
        ...
        <div>
            ...
            <span style={{ fontSize: 15 }}>
              <span>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">flownftalert@gmail.com</bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">Flow NFT Alert</bdt>
                <bdt className="statement-end-if-in-editor" /> and the Services, the choices you
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/57ad83e9-0943-4df0-a214-5502b0cbc162"
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <bdt className="block-component" />, or by contacting us. We will consider and act
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">Flow NFT Alert</bdt>
                <bdt className="statement-end-if-in-editor" /> does with any information we collect?
                Click&nbsp;
              </span>
            </span>
            <a data-custom-class="link" href="#toc">
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <a data-custom-class="link" href="#DNT">
                <span>9. CONTROLS FOR DO-NOT-TRACK FEATURES</span>
              </a>
            </span>
          </div>
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <a data-custom-class="link" href="#caresidents">
                <span>10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span>
              </a>
            </span>
            <bdt className="block-component">
              <span style={{ fontSize: 15 }}>
          ...
          <div style={{ lineHeight: '1.5' }}>
            <a data-custom-class="link" href="#contact">
              <span style={{ fontSize: 15 }}>13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>
            </a>
          </div>
          <div style={{ lineHeight: '1.5' }}>
                                                ...
                                                <div style={{ lineHeight: '1.5' }}>
                                                  ...
                                                  <div style={{ lineHeight: '1.5' }}>
                                                    ...
                                                    <div style={{ lineHeight: '1.5' }}>
                                                      <span style={{ fontSize: 15 }}>
                                                        <span data-custom-class="body_text">
                                                          ...
                                                          the valid legal bases we rely on in order
                                                          to process your personal information. As
                                                          such, we may rely on the following legal
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          <span style={{ fontSize: 15 }}>
                                                            ...
                                                            believe it is necessary to protect your
                                                            vital interests or the vital interests
                                                    ...
                                                    <div style={{ lineHeight: '1.5' }}>
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          <span style={{ fontSize: 15 }}>here</span>
                                                        </span>
                                                      </a>
                                                      <span data-custom-class="body_text">
                                                        <span style={{ fontSize: 15 }}>
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          <span style={{ fontSize: 15 }}>
                                                            ...
                                                            necessary to assess, process, or settle
                                                            an insurance claim
                                                          </span>
                                                        </span>
                                                        <bdt className="statement-end-if-in-editor">
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          <span style={{ fontSize: 15 }}>
                                                            ...
                                                            deceased persons and communicating with
                                                            next of kin
                                                          </span>
                                                        </span>
                                                        <bdt className="statement-end-if-in-editor">
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          <span style={{ fontSize: 15 }}>
                                                            ...
                                                            and use with consent would compromise
                                                            the availability or the accuracy of the
                                                            information and the collection is
                                                            reasonable for purposes related to
                                                            investigating a breach of an agreement
                                                            or a contravention of the laws of Canada
                                                            or a province
                                                            <bdt className="statement-end-if-in-editor" />
                                                          </span>
                                                        </span>
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          <span style={{ fontSize: 15 }}>
                                                            ...
                                                            a subpoena, warrant, court order, or
